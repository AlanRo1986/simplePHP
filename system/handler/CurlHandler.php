...
use App\System\Data\CaseInsensitiveArray;
...
class CurlHandler
{
    ...
    private $jsonDecoder = '\App\System\Utils\DecoderUtils::decodeJson';
    private $jsonDecoderArgs = array();
    private $jsonPattern = '/^(?:application|text)\/(?:[a-z]+(?:[\.-][0-9a-z]+){0,}[\+\.]|x-)?json(?:-[a-z]+)?/i';
    private $xmlDecoder = '\App\System\Utils\DecoderUtils::decodeXml';
    ...
    public function buildPostData($data)
    {
        ...
        if (is_array($data)) {
            ...
            if (isset($this->headers['Content-Type']) &&
                ...
                // referenced.
                if (ArrayUtils::is_array_multidim($data)) {
                    $data = ArrayUtils::array_flatten_multidim($data);
                }
    ...
    {
        $this->jsonDecoder = '\App\System\Utils\DecoderUtils::decodeJson';
    ...
    {
        $this->xmlDecoder = '\App\System\Utils\DecoderUtils::decodeXml';
    }
